...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->pushNamePrefix("clk_tick_block ");
...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullSData(oldp+2,(vlSelf->top__DOT__clk_tick_block__DOT__count),16);
    bufp->fullIData(oldp+3,(vlSelf->top__DOT__f1_fsm_block__DOT__current_state),32);
    bufp->fullIData(oldp+4,(vlSelf->top__DOT__f1_fsm_block__DOT__next_state),32);
