...
VL_INLINE_OPT void Vtop___024root___sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    // Init
    SData/*15:0*/ __Vdly__top__DOT__clk_tick_block__DOT__count;
    // Body
    __Vdly__top__DOT__clk_tick_block__DOT__count = vlSelf->top__DOT__clk_tick_block__DOT__count;
    if (VL_UNLIKELY(vlSelf->top__DOT__tick)) {
        VL_WRITEF("%1#\n",1,vlSelf->top__DOT__tick);
    }
    if (vlSelf->rst) {
        vlSelf->top__DOT__f1_fsm_block__DOT__current_state = 0U;
        vlSelf->top__DOT__tick = 0U;
        __Vdly__top__DOT__clk_tick_block__DOT__count 
            = vlSelf->N;
    } else {
        vlSelf->top__DOT__f1_fsm_block__DOT__current_state 
            = vlSelf->top__DOT__f1_fsm_block__DOT__next_state;
        if ((0U == (IData)(vlSelf->top__DOT__clk_tick_block__DOT__count))) {
            vlSelf->top__DOT__tick = 1U;
            __Vdly__top__DOT__clk_tick_block__DOT__count 
                = vlSelf->N;
        } else {
            __Vdly__top__DOT__clk_tick_block__DOT__count 
                = (0xffffU & ((IData)(vlSelf->top__DOT__clk_tick_block__DOT__count) 
                              - (IData)(1U)));
            vlSelf->top__DOT__tick = 0U;
        }
    }
    ...
    vlSelf->top__DOT__clk_tick_block__DOT__count = __Vdly__top__DOT__clk_tick_block__DOT__count;
}
